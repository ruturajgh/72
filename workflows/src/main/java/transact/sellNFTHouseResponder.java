 ...
 */
@InitiatedBy(sellNFTHouse.class)
public class sellNFTHouseResponder extends FlowLogic<SignedTransaction> {

    private final FlowSession counterpartySession;

    public sellNFTHouseResponder(FlowSession counterpartySession) {
